    ...
    <>
      <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
          <div className="bg-secondaryColor p-3 flex flex-0.7 w-full"></div>
          ...
          <div className=" flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className=" absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-all druation-500 ease-in-out"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input
            ...
            className=" outline-none text-xs border-b-2 border-gray-200 p-1"
          />
          <input
            type="text"
            value={destination}
